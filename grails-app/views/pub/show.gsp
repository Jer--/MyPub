		...
		<ol class="property-list pub">
			...
			<g:if test="${pubInstance?.name}">
				<li class="fieldcontain"><span id="name-label"
					...
					aria-labelledby="name-label"><g:fieldValue
							bean="${pubInstance}" field="name" /></span></li>
			</g:if>
			...
			<g:if test="${pubInstance?.address}">
				<li class="fieldcontain"><span id="address-label"
					...
					aria-labelledby="address-label"><g:fieldValue
							bean="${pubInstance}" field="address" /></span></li>
			</g:if>
			...
			<g:if test="${pubInstance?.latitude}">
				<li class="fieldcontain"><span id="latitude-label"
					class="property-label"><g:message code="pub.latitude.label"
							default="Latitude" /></span> <span class="property-value"
					aria-labelledby="latitude-label"><g:fieldValue
							bean="${pubInstance}" field="latitude" /></span></li>
			</g:if>

			<g:if test="${pubInstance?.longitude}">
				<li class="fieldcontain"><span id="longitude-label"
					class="property-label"><g:message code="pub.longitude.label"
							default="Longitude" /></span> <span class="property-value"
					aria-labelledby="longitude-label"><g:fieldValue
							bean="${pubInstance}" field="longitude" /></span></li>
			</g:if>
			...
			<g:if test="${pubInstance?.pictures}">
				<li class="fieldcontain"><span id="pictures-label"
					class="property-label"><g:message code="pub.pictures.label"
							default="Pictures" /></span> <g:each in="${pubInstance.pictures}"
						var="p">
						<span class="property-value" aria-labelledby="pictures-label"><g:link
								controller="picture" action="show" id="${p.id}">
								${p?.encodeAsHTML()}
							</g:link></span>
					</g:each></li>
			</g:if>
			...
			<g:if test="${pubInstance?.modifications}">
				<li class="fieldcontain"><span id="modifications-label"
					class="property-label"><g:message
						...
						<span class="property-value" aria-labelledby="modifications-label"><g:link
			...
			<g:if test="${pubInstance?.coments}">
				<li class="fieldcontain"><span id="coments-label"
					class="property-label"><g:message code="pub.coments.label"
							default="Coments" /></span> <g:each in="${pubInstance.coments}" var="c">
						<span class="property-value" aria-labelledby="coments-label"><g:link
								controller="coment" action="show" id="${c.id}">
								${c?.encodeAsHTML()}
							</g:link></span>
					</g:each></li>
			</g:if>
