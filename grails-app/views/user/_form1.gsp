...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'avatar', 'error')} " style="display:none; visibility:hidden">
	<label for="avatar">
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'friends', 'error')} " style="display:none; visibility:hidden">
	<label for="friends">
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'pictures', 'error')} " style="display:none; visibility:hidden">
	<label for="pictures">
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'pubs', 'error')} " style="display:none; visibility:hidden">
	<label for="pubs">
