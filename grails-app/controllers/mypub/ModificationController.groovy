...
class ModificationController {
    ...
    def save() {
        ...
        flash.message = message(code: 'default.created.message', args: [message(code: 'modification.label', default: 'Modification'), modificationInstance.id])
    ...
    def show(Long id) {
        ...
        if (!modificationInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'modification.label', default: 'Modification'), id])
    ...
    def update(Long id, Long version) {
        ...
        flash.message = message(code: 'default.updated.message', args: [message(code: 'modification.label', default: 'Modification'), modificationInstance.id])
        redirect(action: "show", id: modificationInstance.id)
    }
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'modification.label', default: 'Modification'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'modification.label', default: 'Modification'), id])
